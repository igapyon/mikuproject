---
title: mikuproject miku-soft reference
...
sources:
  ...
  - type: local-file
    ...
    label: mikuproject product architecture
    checked: 2026-08-05
---

# mikuproject miku-soft Reference
...
- `src/ts/` is the source of truth. The tracked `src/js/`, `index.html`, and `mikuproject.html` files are intentional generated browser artifacts for this still-combined repository and must be rebuilt, not hand-edited.
- `bundle/mikuproject.mjs` is the intentionally single-file Node CLI runtime consumed by downstream Agent Skills. It is regenerated with `npm run build:cli-bundle`.
...
For product-specific architecture and command details, use [architecture.md](architecture.md), [development.md](development.md), and [mikuproject-ai-json-spec.md](mikuproject-ai-json-spec.md).
